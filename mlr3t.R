toyotacorola<- read.csv(file.choose())
View(toyotacorola)
class(toyotacorola)

attach(toyotacorola) # Basically to avoid reference of Data Set name(Corolla) in this report.
...
influenceIndexPlot(corolla.price, id.n=3) # Index Plots of the influence measure
